const SAMPLE_H='The Quick Brown Fox Jumps Over the Lazy Dog';
const SAMPLE_P='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.';
/* istanbul ignore next */
function loadFont(name){if(typeof document==='undefined')return;const id='gf-'+name.replace(/\s/g,'-');if(document.getElementById(id))return;const link=document.createElement('link');link.id=id;link.rel='stylesheet';link.href='https://fonts.googleapis.com/css2?family='+encodeURIComponent(name)+':wght@400;700&display=swap';document.head.appendChild(link)}
/* istanbul ignore next */
...
/* istanbul ignore next */
function getImportCSS(){if(typeof document==='undefined')return'';const hf=document.getElementById('head-font');const bf=document.getElementById('body-font');return"@import url('https://fonts.googleapis.com/css2?family="+encodeURIComponent(hf?hf.value:'Playfair Display')+":wght@400;700&family="+encodeURIComponent(bf?bf.value:'Inter')+":wght@400;700&display=swap');"}
/* istanbul ignore next */
function copyCSS(){if(navigator.clipboard)navigator.clipboard.writeText(getImportCSS())}
/* istanbul ignore next */
...
/* istanbul ignore next */
if(typeof module!=='undefined'&&module.exports)module.exports={loadFont,preview,getImportCSS,copyCSS,init,SAMPLE_H,SAMPLE_P};
